...
class CircleOnShell extends React.Component {
  ...
  renderVals() {
    ...
    const titleStyle = (active) => `font-family:'Cormorant Garamond',serif;font-size:${active ? 21 : 19}px;font-weight:400;margin:22px 0 8px;color:${dark ? active ? '#FFF8FF' : '#CFC3D5' : active ? '#1A172C' : '#423F54'};cursor:pointer;display:inline-flex;align-items:center;gap:6px;transition:color .3s,font-size .3s`;
